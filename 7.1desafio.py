...
def adicionar_tarefa(tarefas):
    descricao = input("Digite o iten que deseja inserir : ")
    tarefas.append([descricao, "❌ iten Pendente"])
    salvar_tarefas(tarefas)
    print( "✔️iten adicionado com sucesso!\n")
...
def concluir_tarefa(tarefas):
    ...
    try:
        indice = int(input("Digite os itens estão no estoque : ")) -1
        if 0 <= indice < len(tarefas):
            print(f"Tarefa '{tarefas[indice][0]} ITEN ESTA NO ESTOQUE ! \n")
...
def main():
    ...
    while True:
        print("1. ADICIONAR O ITEN ")
        print("2. listar ITENS")
        print("3. validar se esta no estoque")
        print("4. Excluir MERCADORIAS ")
        print("5. Sair")
